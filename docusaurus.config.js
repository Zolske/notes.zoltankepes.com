...
const config = {
  ...
  tagline:
    "This site contains a collection of my programming notes. Feel free to have a look around ...",
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: "https://github.com/Zolske/notes.zoltankepes.com/tree/main",
        },
        blog: {
  ...
  themeConfig:
    ...
    ({
      ...
      // the footer has been overwritten with, see /src/theme/Footer/Layout/index.js
      footer: {
        style: "dark",
        links: [
          // {
